inherited frm2Categoria: Tfrm2Categoria
  Caption = 'Categorias'
  OnCreate = FormCreate
  PixelsPerInch = 96
  TextHeight = 13
  inherited pnlTop: TPanel
    inherited hdrTitulo: TJvGradientHeaderPanel
      LabelCaption = '.: Categorias Cadastradas'
    end
  end
      ...
      inherited cxGridTV1: TcxGridDBTableView
        ...
        DataController.Summary.FooterSummaryItems = <
          item
            Format = 'Total :#'
            Kind = skCount
            Column = cxGridCodCategoria
            DisplayText = 'Total:'
          end>
        object cxGridCodCategoria: TcxGridDBColumn
          Caption = 'C'#243'digo'
          DataBinding.FieldName = 'ID'
        end
        object cxGridNomeCategoria: TcxGridDBColumn
          Caption = 'Nome'
